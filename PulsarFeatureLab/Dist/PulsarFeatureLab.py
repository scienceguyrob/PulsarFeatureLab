    ...
    def main(self,argv=None):
        ...
        if(utils.fileExists(self.out)):
            ...
            if(not utils.fileExists(self.out)):
                print "You must supply a valid output file path with -d flag."
                sys.exit()
        ...
        if(self.candidate_type < 1 or self.candidate_type > 3):
            print "You must indicate the type of candidate file features will be extracted from with the -i flag."
